...
class TransportImpl extends enhancedEvents_1.EnhancedEventEmitter {
    ...
    async produce({ id = undefined, kind, rtpParameters, paused = false, keyFrameRequestDelay, enableMediasoupPacketIdHeaderExtension, appData, }) {
...
function createProduceRequest({ builder, producerId, kind, rtpParameters, rtpMapping, paused, keyFrameRequestDelay, enableMediasoupPacketIdHeaderExtension, }) {
    ...
    FbsTransport.ProduceRequest.addEnableMediasoupPacketIdHeaderExtension(builder, enableMediasoupPacketIdHeaderExtension ?? false);
