...
function generateRouterRtpCapabilities(mediaCodecs = []) {
    ...
    const dependencyDescriptorHeaderExtensionForPipeConsumer = supportedRtpCapabilities_1.supportedRtpCapabilities.headerExtensions.find(headerExtension => headerExtension.uri ===
    ...
    if (dependencyDescriptorHeaderExtensionForPipeConsumer) {
        cache.dependencyDescriptorHeaderExtensionParametersForPipeConsumer = {
            ...
            encrypt: dependencyDescriptorHeaderExtensionForPipeConsumer.preferredEncrypt,
            parameters: {},
        };
    }
    return caps;
...
function getPipeConsumerRtpParameters({ consumableRtpParameters, enableRtx, }) {
    ...
    if (cache.dependencyDescriptorHeaderExtensionParametersForPipeConsumer) {
        consumerParams.headerExtensions.push(cache.dependencyDescriptorHeaderExtensionParametersForPipeConsumer);
